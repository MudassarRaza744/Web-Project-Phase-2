<?php 
    ...
    $product_id=$_GET['id'];
    $Query="SELECT* FROM product_data where PRODUCT_ID=".$product_id." "; //selecting specifically from the produc_data table with id
...
<html>
<head>
	<title><?php echo $postvalues['PRODUCT_INFO'] ?></title>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6" style="margin-top: 50px;">
        ...
        <div>
           <p><?php echo $postvalues['PRODUCT_NAME']?></p>
        </div>
        ...
        <span ><?php echo $postvalues['PRODUCT_WARRANTY'] ?>-Year</span>
        </div>
        ...
        <div>
          <span><strong>Rs.</strong><?php echo $postvalues['PRODUCT_PRICE']?></span>
        </div>
        <div>
          <span><strong>Product Catagory:</strong><?php echo $postvalues['product_catagories']?></span>
        </div>
      </div>
    </div>
