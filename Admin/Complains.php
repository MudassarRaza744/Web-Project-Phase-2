...
<br><h2 style="padding-left: 2%">Complains From Users</h2><br><br>
...
<?php
while($res=mysqli_fetch_array($postquery))
{
?>
...
<tr>
  ...
  <td align="center"><?php echo $res['City']  ?></td>
  <td align="center"><?php echo $res['Address']  ?></td>
  <td align="center" style="max-width: 250px; word-wrap: break-word;"><?php echo $res['Message']  ?></td>
  <td align="center">
  <button class="btn btn-warning" onclick="view_message(<?php echo $res['Id']  ?>) ">View</button>
  <button class="btn btn-danger" onclick="delete_message(<?php echo $res['Id']  ?>)" >Delete</button>
  </td> 
...
?>
  ...
  <script>
      function delete_message(id)
      {
        ...
        {
          window.location.href="delete_complain.php?id="+id+" ";
        }
      }
